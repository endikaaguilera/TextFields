...
class ViewController: UIViewController, UITextFieldDelegate {
    ...
    func initKeyboarHandler() {
        NotificationCenter.default.addObserver(self, selector: #selector(keyboarHandler), name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(keyboarHandler), name: UIResponder.keyboardWillChangeFrameNotification, object: nil)
    }
